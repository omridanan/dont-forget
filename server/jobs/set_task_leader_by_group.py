...
def run():
    ...
    for tasks_group in tasks_groups:
        ...
        for task_id in tasks_ids:
            ...
            print("taskId: " + str(task_id) + ", entities: ")
            ...
            print("This is the result dictionary after adding task entityies: " + str(task_id))
        ...
        print("insert new entities_count to db to entities_group collection for task_group_id: " + str(task_group_id))
        ...
        print("all entities count for task_group_id " + str(task_group_id))
        ...
        for task_id in tasks_ids:
            print("looking now on task_id " + str(task_id))
            task_rank = 0
        ...
        max_task_id = max(tasks_ranks_dictionary.items(), key=operator.itemgetter(1))[0]
